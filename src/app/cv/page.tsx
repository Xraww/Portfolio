  ...
  return (
    <section className="flex flex-col mx-4 my-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center border-b pb-2 gap-4 md:gap-0">
        <h1 className="text-2xl md:text-3xl font-semibold font-mono">
        ...
        <div className="flex gap-4">
            <div className="flex items-center gap-4">
                ...
                >
                    <Link 
                        href={`/cv/VERTICAL CV - ${language === "fr" ? "FR" : "EN"}.pdf`}
                        download={`CV_Alexis_Bonzi_${language === "fr" ? "FR" : "EN"}.pdf`}
                        target="_blank"
                    >
                        Download Basic CV ({language === "fr" ? "FR" : "EN"})
                    </Link>
                </Button>
            </div>
      ...
      <div className="flex flex-col gap-6 md:flex-row">
        <div className="flex flex-col items-center gap-4 md:w-1/3">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex flex-col items-center gap-4">
              <h2 className="text-lg font-semibold font-mono text-center">
                Alexis Bonzi
              </h2>
              <p className="text-sm text-muted-foreground font-mono border-b pb-1">
                {CV_Translation.job[language]}
              </p>
            </div>

            <p className="text-sm text-muted-foreground font-mono text-center">
              {CV_Translation.description[language]}
            </p>
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="link"
                size="sm"
                className="font-mono p-2 border hover:bg-accent hover:text-accent-foreground"
                asChild
              >
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-4 mt-10">
              <div className="flex flex-col gap-4">
                <h3 className="text-md font-semibold font-mono hidden md:block">
                  {CV_Translation.skills.frontend[language]}
                </h3>
                ...
                <div className="hidden md:flex flex-wrap gap-2">
                  {My_Stack_CV.frontend.map((skill) => (
                    <Badge
                      key={skill}
                      variant="outline"
                      className="p-2 flex items-center gap-2 xl:w-[calc(50%-0.5rem)]"
                    >
              ...
              <div className="flex flex-col gap-4">
                <h3 className="text-md font-semibold font-mono hidden md:block">
                  {CV_Translation.skills.backend[language]}
                </h3>
              ...
              <div className="flex flex-col gap-4">
                <h3 className="text-md font-semibold font-mono hidden md:block">
                  {CV_Translation.skills.tools[language]}
                </h3>
              ...
              <div className="flex flex-col gap-4">
                <h3 className="text-md font-semibold font-mono hidden md:block">
                  {CV_Translation.skills.other[language]}
                </h3>
        ...
        <div className="flex flex-col gap-4 w-full md:border-l-2 md:pl-4 md:flex-1">
          <div className="flex flex-col gap-4">
            <h3 className="border-b pb-2 text-md font-semibold font-mono md:hidden">
              {CV_Translation.skills.frontend[language]}
            </h3>
          ...
          <div className="flex flex-col gap-4">
            <h3 className="border-b pb-2 text-lg font-semibold font-mono">
              {CV_Translation.experience[language]}
            </h3>

            {My_Experience.map((experience) => (
              <div
                key={experience.company[language]}
                className="relative flex flex-col gap-2 border-l-2 pl-4 md:gap-1.5"
              >
          ...
          <div className="flex flex-col gap-4">
            <h3 className="border-b pb-2 text-lg font-semibold font-mono">
              {CV_Translation.education[language]}
            </h3>

            <div className="flex flex-col gap-2">
              {My_Education.map((education) => (
                <div
                  key={education.name[language]}
